...
//   return (
//     <div className="w-full py-12 h-full relative bg-gradient-to-b from-[#00b4d8] to-[#0096c7]">
...
const Section2 = () => {
  ...
  return (
    <div className="w-full py-12 h-full relative bg-gradient-to-b from-[#00b4d8] to-[#0096c7]">
      <div className="h-[90vh] absolute md:top-[28%] md:left-[48%] flex flex-col items-center">
        <div>
          <img src="/assets/section-two-ball.png" className="w-20 h-full" alt="Bubble" />
        </div>
        <div className="bg-white h-52 w-[2px]" />
        <div>
          <img src="/assets/section-two-ball.png" className="w-20 h-full" alt="Bubble" />
        </div>
        <div className="bg-white h-52 w-[2px]" />
      ...
      <div className="relative">
        <div className="mx-auto max-w-screen-2xl md:px-40">
          ...
          <div className="flex items-end justify-end my-20 text-white">
