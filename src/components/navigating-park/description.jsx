...
export default function NavDescription() {
  ...
  // const shellData = [
  //   {
  //     image: "/assets/navigating-park/shell/product-one.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  //   {
  //     image: "/assets/navigating-park/shell/product-two.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  //   {
  //     image: "/assets/navigating-park/shell/product-three.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  //   {
  //     image: "/assets/navigating-park/shell/product-four.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  // ]
  // const elementsData = [
  //   {
  //     image: "/assets/navigating-park/elements/product-one.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  //   {
  //     image: "/assets/navigating-park/elements/product-two.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  //   {
  //     image: "/assets/navigating-park/elements/product-three.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  //   {
  //     image: "/assets/navigating-park/elements/product-four.png",
  //     btnOne: "/assets/navigating-park/navigating-park-add-button.png",
  //     btnTwo: "/assets/navigating-park/navigating-park-download-button.png"
  //   },
  // ]
  ...
  return (
    ...
    <>
      ...
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-venue.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-event-shell.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-event-element.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-element-furniture.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-floristy-element.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-av-package.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/pick-graphics-package.png" alt="" />
      </div>
      <div>
        <img className="w-full" src="/assets/navigating-park/arrow-bottom.png" alt="" />
      </div>
      ...
      {/* <section className="relative min-h-[600px] w-full bg-gradient-to-b from-[#00b4d8] to-[#0096c7] flex items-center justify-center p-8">
        <div className="relative mx-auto flex justify-center">
          <img src="/assets/navigating-park/arrow.png" className="w-10/12" alt="" />
        </div>
      </section>
      <section className="relative min-h-[600px] w-full bg-gradient-to-b from-[#00b4d8] to-[#0096c7] p-8">
        <div className="relative mx-auto flex justify-center">
          <img src="/assets/navigating-park/shell/shell-text.png" className="w-96" alt="" />
        </div>
        <div className="grid md:grid-cols-4 gap-5">
          {shellData?.map((item) => (
            <div className="flex flex-col justify-center items-center gap-4">
              <img src={item?.image} className="w-96" alt="" />
              <img src={item?.btnOne} className="w-40" alt="" />
              <img src={item?.btnTwo} className="w-40" alt="" />
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="relative min-h-[600px] w-full bg-gradient-to-b from-[#00b4d8] to-[#0096c7] p-8">
        <div className="relative mx-auto flex justify-center">
          <img src="/assets/navigating-park/elements/elements-text.png" className="w-96" alt="" />
        </div>
        <div className="grid md:grid-cols-4 gap-5">
