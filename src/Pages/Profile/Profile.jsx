...
const Profile = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-br from-[#00083c] via-[#73cddd] relative overflow-hidden">
      <Particles
      ...
      >
        ...
        <div className="flex justify-center items-center mt-6">
          ...
          <form onSubmit={formik.handleSubmit} className="w-3/4 ml-6">
